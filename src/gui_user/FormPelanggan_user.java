 ...
 * @author handa
 */
public class FormPelanggan_user extends javax.swing.JInternalFrame {
    pelanggan pl;
    utama ut;
   
    public FormPelanggan_user() {
        initComponents();
...
boolean edit = false;
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
            ...
            try {
                ...
                Logger.getLogger(FormPelanggan_user.class.getName()).log(Level.SEVERE, null, ex);
            }
        }else{
            String id_pelanggan = txid.getText();
            String nama_pelanggan = txnama.getText();
